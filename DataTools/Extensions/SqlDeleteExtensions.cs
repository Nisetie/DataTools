...
namespace DataTools.Extensions
{
    public static class SqlDeleteExtensions
    {
        ...
        public static SqlDelete Where(this SqlDelete sqlDelete, string columnName, object value) => sqlDelete.Where(new SqlWhereClause(new SqlName(columnName)).Eq(new SqlConstant(value)));
    }
